...
// from TTree FOTRA/Panda trakers
// found on file: /home/pandastraws/hldFiles/asicSource/cosmics/1800V/cosmics1800_FOTRA.root
//////////////////////////////////////////////////////////

#ifndef TFotraSelector_h
#define TFotraSelector_h
...
public :
   ...
   TFotraSelector(TTree *tree, string);
   virtual ~TFotraSelector();
...
#ifdef TFotraSelector_cxx
TFotraSelector::TFotraSelector(TTree *tree, string fname) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
  // if (tree == 0) {
  //    TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/pandastraws/hldFiles/asicSource/cosmics/1800V/cosmics1800_FOTRA.root");
  //    if (!f || !f->IsOpen()) {
  //       f = new TFile("/home/pandastraws/hldFiles/asicSource/cosmics/1800V/cosmics1800_FOTRA.root");
  //    }
  //    f->GetObject("FOTRA",tree);
   ...
   Init(tree);
   tree_out = new TTree("FOTRAC","Forward trakers calibrated");
...
Long64_t TFotraSelector::LoadTree(Long64_t entry)
{
...
void TFotraSelector::Init(TTree *tree)
{
...
void TFotraSelector::Show(Long64_t entry)
{
...
Int_t TFotraSelector::Cut(Long64_t entry)
{
...
#endif // #ifdef TFotraSelector_cxx
