...
#include <iostream>
#include <utility>
void TPatraSelector::Loop(unsigned eventsQty)
{
//   In a ROOT session, you can do:
//      Root > .L TPatraSelector.C
//      Root > TPatraSelector t
...
void TPatraSelector::AttachCalibration(TStrawCalibration *in_calib){
calibModule = in_calib;
}
void TPatraSelector::AttachGeometry(TStrawGeometry *in_geom){
